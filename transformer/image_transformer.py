...
class Transformer(object):
    ...
    def __init__(self, params, train):
        ...
        self.encoder = ImageEncoder(params, train)
    ...
    def _get_symbols_to_logits_fn(self, max_decode_length):
        ...
        def symbols_to_logits_fn(ids, i, cache):
            ...
            decoder_outputs = self.decoder_stack(
                decoder_input, cache.get("encoder_outputs"), self_attention_bias, cache)
    ...
    def predict(self, encoder_input_tokens, encoder_outputs):
...
class ImageEncoder(tf.layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        with tf.variable_scope(inception_resnet_v2_arg_scope()):
            logits, end_points = inception_resnet_v2(inputs, 0, self.train)
        return end_points
